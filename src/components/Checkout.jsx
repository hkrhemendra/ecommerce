...
const Checkout = () => {
  ...
  const cartArray = Object.values(cartItems.productList);
  const totalAmount = cartArray.reduce((acc, ele) => acc + (ele.price * ele.quantity), 0)
          ...
          <ul className="list-group mb-3">
            {cartArray?.map((ele) => (
              <li className="list-group-item d-flex justify-content-between lh-sm">
                ...
                <span className="text-body-secondary">${ele.price} X {ele.quantity}</span>
              </li>
            ))}
